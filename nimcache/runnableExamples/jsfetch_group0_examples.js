...
function reprEnum(e_33557382, typ_33557383) {
  var result_33557384 = [];

  var F={procname:"system.reprEnum",prev:framePtr,filename:"/home/runner/work/Nim/Nim/lib/system/reprjs.nim",line:0};
  framePtr = F;
    F.line = 25;
    var tmp_33557385 = false;
    F.line = 26;
    var item_33557386 = typ_33557383.node.sons[e_33557382];
    F.line = 27;
    tmp_33557385 = item_33557386 !== undefined
    if (tmp_33557385) {
    F.line = 29;
    result_33557384 = nimCopy(null, makeNimstrLit(item_33557386.name), NTI33554439);
    }
    else {
      F.line = 31;
      result_33557384 = nimCopy(null, (cstrToNimstr((e_33557382)+"") || []).concat(makeNimstrLit(" (invalid data!)") || []), NTI33554439);
    }
